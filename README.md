...
At the moment, I will not be accepting other contributions as I don't think the kernel is at a place to be accepting them yet. At the moment there is not even a system to print text on the screen, there is no panic function, the kernel is very very simple right now, and it doesn't really do anything (Even a simple memory error can cause a triple fault). I will probably be accepting contributions in a few days, and I will update this readme when I think I'm ready to start accepting contributions.
